...
+ '#tab_goldswing .card.gsw-card{color:#0F172A}'
+ '#tab_goldswing .card.gsw-card .sym{color:#020617!important;font-weight:800}'
+ '#tab_goldswing .card.gsw-card .mini{color:#0F172A}'
+ '#tab_goldswing .card.gsw-card .mini .k{color:#475569!important;font-weight:700}'
+ '#tab_goldswing .card.gsw-card .mini span:not(.k){color:#020617!important;font-weight:600}'
+ '#tab_goldswing .card.gsw-card .gpip{background:#F1F5F9!important;border-color:#CBD5E1!important;color:#334155!important}'
+ '#tab_goldswing .card.gsw-card .gpip.ok{background:#ECFDF5!important;border-color:#059669!important;color:#047857!important;font-weight:700}'
+ '#tab_goldswing .card.gsw-card .plan{background:#F0FDF4!important;border-color:#BBF7D0!important;color:#0F172A!important}'
+ '#tab_goldswing .card.gsw-card .plan b{color:#047857!important}'
+ '#tab_goldswing .card.gsw-card .note{color:#334155!important}'
+ '#tab_goldswing .card.gsw-card .toTrade{color:#047857!important;border-color:#059669!important;background:rgba(5,150,105,.08)!important}'
+ '#tab_goldswing .card.gsw-card .toBook{color:#0891B2!important;border-color:#0891B2!important;background:rgba(8,145,178,.06)!important}'
