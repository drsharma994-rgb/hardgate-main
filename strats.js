...
function sgEquityChart(el, trades){
  ...
  try{
    ...
    var chart = LC.createChart(el, {
      height: 220,
      layout: { background: { type: 'solid', color: 'transparent' }, textColor: '#6B7A90', attributionLogo: false },
      grid: { vertLines: { color: 'rgba(35,43,58,.55)' }, horzLines: { color: 'rgba(35,43,58,.55)' } },
    ...
    try{
      if (typeof eqS.createPriceLine === 'function'){
        eqS.createPriceLine({ price: 0, color: '#6B7A90', lineWidth: 1,
