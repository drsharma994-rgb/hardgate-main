...
function parseDeltaCandles(payload){
...
function parseDeltaTicker(payload){
 ...
 */
async function fetchDeltaPerpHistory(opts){
  opts = opts || {};
...
const DELTA_PERP_DEFAULT_SYMBOL = DEFAULT_SYMBOL;
const DELTA_API_BASE = DELTA;

module.exports = {
  parseDeltaCandles,
  parseDeltaTicker,
  parseDeltaL2,
  fetchDeltaPerpHistory,
  DELTA_PERP_DEFAULT_SYMBOL,
  DELTA_API_BASE
};
