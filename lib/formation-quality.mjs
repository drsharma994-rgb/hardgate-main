...
import { heyDeskMacroScore } from './hey-lens-core.mjs';
...
function macroScore(cand) {
  ...
  if (cand.heyDesk || cand.socialRiskScore != null) {
    return heyDeskMacroScore(cand, cand.heyDesk || { socialRiskScore: cand.socialRiskScore });
  }
