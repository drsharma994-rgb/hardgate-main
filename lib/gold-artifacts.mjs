...
/* The GOLD SWING walk. hg-v961 gave that desk the live population hg-v916
   built for scalp and never extended; the path is named here for the same
   reason as the others - one home, so a writer and a reader cannot disagree. */
export const GOLD_SWING_WALK = join(SCRIPTS, 'backtest-goldswing-results.json');
