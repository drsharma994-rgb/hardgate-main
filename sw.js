...
const HG_SHELL = [
  ...
  './squeeze.js', './trendtable.js', './oiflow.js', './regime.js', './carry.js', './hg-forward.js', './hg-mechanics.js', './hg-gates.js', './omniroute.js', './omnigold.js', './contract-report.js', './termbasis.js',
