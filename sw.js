...
const HG_SHELL = [
  ...
  './setup-ui.js', './setup-solidity.js', './setup-calibration.js', './plans.js', './setup-stack.js', './gate-replay-oos.js', './cryptogates.js',
  './squeeze.js', './trendtable.js', './oiflow.js', './regime.js', './carry.js', './hg-forward.js', './hg-mechanics.js', './hg-gates.js', './hg-plan.js', './crypto-catalog.js', './omniroute.js', './dex-screener.js', './setup-confirm.js', './combi.js', './gold-formation.js', './omnigold.js', './omnigold1.js', './newgold.js', './omnipresent.js', './formation-nightly.js', './formation-nightly-boot.js', './desk-formation-edge.js', './hg-omni-strategy-bridge.js', './contract-report.js', './omnibtc-engines.js', './omnibtc.js', './termbasis.js',
  './goldpro.js', './strats.js', './meanrev.js', './supersetup.js', './super-desk-common.js', './super-gold.js', './super-best.js', './super-sniper.js', './super-book.js', './super-calibrate.js', './reversalsniper.js', './edge.js', './startradertab.js', './book-routing.js', './api-client.js', './tradeos.js', './hey-lens.js', './book.js', './setup-activation.js', './execute.js', './liqs.js', './xuniverse.js', './desk-scan-universe.js',
