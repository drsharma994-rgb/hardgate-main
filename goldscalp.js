...
+ '#tab_goldscalp .card.gsx-card{color:#0F172A}'
+ '#tab_goldscalp .card.gsx-card .sym{color:#020617!important;font-weight:800}'
+ '#tab_goldscalp .card.gsx-card .mini{color:#0F172A}'
+ '#tab_goldscalp .card.gsx-card .mini .k{color:#475569!important;font-weight:700}'
+ '#tab_goldscalp .card.gsx-card .mini span:not(.k){color:#020617!important;font-weight:600}'
+ '#tab_goldscalp .card.gsx-card .gpip{background:#F1F5F9!important;border-color:#CBD5E1!important;color:#334155!important}'
+ '#tab_goldscalp .card.gsx-card .gpip.ok{background:#ECFDF5!important;border-color:#059669!important;color:#047857!important;font-weight:700}'
+ '#tab_goldscalp .card.gsx-card .plan{background:#FFFBEB!important;border-color:#FDE68A!important;color:#0F172A!important}'
+ '#tab_goldscalp .card.gsx-card .plan b{color:#A67C12!important}'
+ '#tab_goldscalp .card.gsx-card .note{color:#334155!important}'
+ '#tab_goldscalp .card.gsx-card .toTrade{color:#047857!important;border-color:#059669!important;background:rgba(5,150,105,.08)!important}'
+ '#tab_goldscalp .card.gsx-card .toBook{color:#0891B2!important;border-color:#0891B2!important;background:rgba(8,145,178,.06)!important}'
