...
var HG_BUILD = {
  version: 'hg-v712',
  pack: 'CRYPTO SCAN updated: UI text now explains the self-canceling rule (votes too correlated, long/short overlap cancels to 0 trades); threshold clarified as 70% (up from 55%); all setups clearly marked unverified, record-only, not for trading',
