...
var HG_BUILD = {
  version: 'hg-v860',
  pack: 'the Silver Bullet windows keep the hour they are named after. hgGoldSessionBoundWindow gates the silverb mint on GOLD SCALP, the SILVER BULLET stamp on GOLD SWING and the forming panel on all three gold desks, and its edges were UTC constants with a line beside them saying what they were supposed to mean: \u201c07:00-09:30 \u2014 first 60-90 min after London open\u201d. London opens at 08:00 London time, which is 07:00 UTC in BST and 08:00 UTC in GMT, so for the five months London spends on GMT the window opened an hour BEFORE the open it is named after and shut half an hour after it. The NY pair is the same shape against the 09:30 New York open: 12:00-13:30 UTC is 08:00-09:30 in EDT and 07:00-08:30 in EST, before the market is there. The numbers were the summer rendering of a local rule written down as if they were the rule; they are the rule now, 08:00-10:30 London and 08:00-09:30 New York, resolved per instant. At 30-minute steps across 2026, 1128 of 17520 verdicts change (6.4%), all of them in winter and in six UTC hours \u2014 summer is byte-identical, and a runtime without Intl falls back to the old UTC rule exactly. The existing June-dated fixtures could never have caught this, which is checked rather than claimed. NOT changed: the session-weight table in hgGoldSessionGate, measured at 20% of the year carrying a different name and 15% a different weight if read as local hours \u2014 it is documented in UTC, means UTC, and its London pair reads winter-anchored while its NY pair reads summer-anchored, so picking one anchor is a trading decision, not a quiet fix. That number is now recorded in the code and pinned by a test',
