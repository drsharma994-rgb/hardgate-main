...
var HG_BUILD = {
  version: 'hg-v856',
  pack: 'a gold alert no longer claims a gate tally the gold desks never kept. Every GOLD Telegram push ended its row \u201ctally +9 \u00b7 GRADE A LOCK \u00b7 3.00R \u00b7 7/7 CLEAN\u201d, and the last three words were never true: GOLD SCALP and GOLD SWING do not run G1-G7 at all \u2014 no gold module sets gatesPassed, clean or clean7 on a setup row anywhere, so no gold row has ever had a seven-gate tally to report. collectGold stamped clean7 unconditionally and then, on the very next line, tested honestly whether the row had a gate count before recording one, a branch that has never once fired. The flag bought nothing either: goldConvicted already carries a gold row through every eligibility filter and the gold batch applies none. Its only consequences were claims \u2014 the push line, the batch Signal line over a mixed batch, the AI AGENT card chip, and a flat +100 in the workforce ranking. tabalerts.js already had the principle written down for 80PERCENT and named GOLD as the precedent for the honest version. setupIsClean7 still answers \u201cmay this row go out\u201d, unchanged; the new setupBacksSevenGates answers \u201ccan it back the claim\u201d, and that is what the printed strings read. The card chip now says GRADE A LOCK or MOST PROBABLE, which the desk had already worked out',
