...
var HG_BUILD = {
  version: 'hg-v715',
  pack: 'CRYPTO SCAN: Quality filtering applied. Engine generates 1768 signals; professional-grade setups filtered to 75%+ confidence + trend regime + liquid hours = ~45-50 tradable candidates per scan. Display separates HQ signals (green) from lower-quality (reference). This is how real traders work: ruthless signal selection. Signal quantity ≠ signal quality.',
