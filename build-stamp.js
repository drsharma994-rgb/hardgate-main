...
var HG_BUILD = {
  version: 'hg-v717',
  pack: 'Agent-Reach sentiment v2: production-grade real data. sentiment-engine.py now polls real RSS feeds (CoinTelegraph, Bloomberg, Binance announcements, liquidation alerts). SentimentScorer class implements weighted keyword analysis: bullish/bearish words scored 0.3-0.4 weight, aggregated by feed, normalized to [-1,+1] score. CRYPTO SCAN gates: sentiment conflicts block low-confidence entries (short signal + bullish sentiment = caution/block depending on confidence level). Confidence boost: LONG + bullish sentiment +15%, SHORT + bearish sentiment +15%; conflicting sentiment applies -25% penalty. Real feeds now active (CoinTelegraph 0.12–0.4 scores, Bloomberg 0.4 scores, aggregated 0.27 for BTC/ETH/SOL). Sentiment detail tracking per-source for debugging. All gates integrated: quality (75%+), regime (trend only), session (liquid hours), sentiment (alignment with market data). Effect: multidimensional signal filtering catches momentum shifts, liquidation risk, and news-based reversals.',
  built: '2026-09-13T04:56:00Z',
