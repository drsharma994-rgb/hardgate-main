...
var HG_BUILD = {
  version: 'hg-v859',
  pack: 'the gold weekend closes on a New York hour, not a UTC one. hgInGoldWeekend is the gate every gold desk asks whether spot gold is shut \u2014 OMNIGOLD turns it into a weekend-exposure ledger row and a -16 demote, GOLD SCALP and GOLD SWING veto on it, SUPER GOLD reports cashOpen from it, and OMNIGOLD TICKET rows are what the XM live-order path sends. Both its edges were the constant 22:00 UTC. That is 17:00 in New York, but only in EST: the spot/CME week turns on 17:00 New York, and for the 238 days a year New York sits in EDT that is 21:00 UTC. So the fixed hour was an hour late at BOTH ends of every summer weekend, wrong in opposite directions \u2014 Friday 21:00-22:00 UTC the book is shut and the gate said open, which is a ticket and on the XM path a live order into a closed market; Sunday 21:00-22:00 UTC the book is open and the gate said shut, an hour of gold setups vetoed every week. Walked hour by hour across 2026: 68 of 8760 verdicts change, which is 34 weekends times those 2 edge hours and nothing else \u2014 every one a Friday or Sunday, every one in the 21:00 UTC hour, winter untouched. The edge is now read from Intl at the instant under test, so the spring weekend correctly shuts at 22:00 and reopens at 21:00, a 71-hour closure. Where Intl cannot report a named-zone offset the fallback is the old constant, so the worst case is exactly the behaviour shipping today. The countdown line printed the literal \u201ch to Fri 22:00 UTC close\u201d too, and now names the hour it is actually counting to. This corrects WHEN the week turns, not the anchor: 17:00 New York is what the old constant already encoded for winter',
