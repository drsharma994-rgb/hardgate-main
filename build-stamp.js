...
var HG_BUILD = {
  version: 'hg-v719',
  pack: 'CRYPTO SCAN v2 COMPLETE: Three-layer professional voting system live. Layer 1 (Price): 470 indicators, 40% weight. Layer 2 (Order Flow): bid-ask imbalance, VWAP divergence, sweep patterns, 35% weight — detects whale accumulation, cascades independent of price. Layer 3 (External): sentiment + liquidation intelligence + whale tracking, 25% weight. Consensus rule: Entry fires IF Layer 1 votes AND (Layer 2 OR Layer 3 doesn't contradict). Confidence = (L1×0.4) + (L2×0.35) + (L3×0.25), all layers agree +15%, diverge -20%. Professional-grade tier: 85%+ confidence, no major conflicts. Risk gates: Liquidation cascade blocks longs; whale distribution penalizes longs; funding extremes caution. Cards show all three layers, agreement status, vote tier, risk flags. Expected: 5-15 trades per scan, 50%+ settled, 60-70% win rate. Decorrelated voting eliminates 50/50 consensus problem.',
