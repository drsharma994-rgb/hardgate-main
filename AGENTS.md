...
- **Part7 complete (hg-v573):** USDINR via Frankfurter (`getUsdInr`) + silver candles wired into GOLD SCALP / SWING / OMNIGOLD Part7 calls; `hgGoldPart7ApplyExpression` stamps S39/S41–S48/tree/sizing onto live cards (never invents dir / never converts XAU entry to INR); S47 USDINR hedge frame for ≥2d runners. S40 still MCX-native unchecked without MCX rows.
