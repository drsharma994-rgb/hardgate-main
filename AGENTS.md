...
- Tests: `node tests/test-goldscalp.mjs`, `node tests/test-goldswing.mjs`, `node tests/test-gold-best-levels.mjs`, `node tests/test-gold-inst-gates.mjs`, `node tests/test-gold-forming-layers.mjs`
