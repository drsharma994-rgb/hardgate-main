...
- **Fix Pack 11 (hg-v177):** **Vol mesh** — Deribit **DVOL** context vote; **spot-perp** taker divergence (Binance spot klines vs fapi) on BEST F8 / BRAIN **spotperp** layer; **stables** dry-powder vote from REGIME (USDT/USDC breakdown). **`tests/test-fix-pack-11.mjs`**.
