...
BOOK **EXEC/LIVE status bar** shows auto EXEC, **BRAIN auto-book**, active-fund **7d bracket** chips, and last blotter event. Multi-fund **desk rollup** (`GET /api/book/desk`) includes cross-fund 7d bracket counts.
