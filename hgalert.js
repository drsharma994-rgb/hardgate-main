...
+ 'border:1px solid var(--line,#E2E8F0);background:var(--panel,#FFFFFF);color:var(--txt,#0F172A);'
...
+ 'color:var(--txt,#0F172A);box-shadow:0 12px 40px rgba(15,23,42,.14);font-size:11px}'
...
+ 'background:transparent;color:var(--txt,#0F172A);font-size:10px;letter-spacing:.1em;cursor:pointer}'
+ '#hgAlertRoot .hgab-lbl{color:var(--mut,#64748B);font-size:10px;display:flex;gap:5px;align-items:center}'
+ '#hgAlertRoot .hgab-lbl input{width:44px;background:var(--ink,#F8FAFC);color:var(--txt,#0F172A);'
