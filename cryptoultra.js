...
var HG_CRYPTO_ULTRA_EVIDENCE = {
  ...
  rule: { minPct: 0.55, regimeGate: true, minAvail: 25, stopAtr: 1.5, costFloorMult: 8, t1R: 1.5, t2R: 2.5, timeoutBars: 24 },
  isAvgR: null,
  isN: 257,
  isWin: 0,
  oosAvgR: null,
  ...
  oosWin: 0,
  tradable: false,
  verdict: 'NOT tradable — all 111 OOS trades timed out (0% win, null avg R); the cost floor (8 x 0.20% RT x ~$77K = ~$1233) widens stops far beyond what 24 bars of 15m BTC can reach.',
  limitations: [
