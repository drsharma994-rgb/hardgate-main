...
{
  ok(/HG_TAB_ALERT_MS = HG_GLOBAL_SCAN_MS/.test(html), 'HG_TAB_ALERT_MS aliases global scan ms');
...
{
  ok(readme.indexOf('5-minute') >= 0 || readme.indexOf('5 min') >= 0, 'README documents 5-min scan cycle');
