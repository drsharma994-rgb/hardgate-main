...
const EXPECTED_GROUPS = {
  ...
  crypto:     ['omnibtc', 'omnipresent', 'omniroute', 'lev20', 'bulls', 'best', 'swing', 'scalp', 'edge', 'smart', 'squeeze', 'reversalsniper', 'smc', 'ob', 'trap', 'div', 'coil', 'apex', 'oiflow', 'liqs', 'onchain', 'chartvision', 'carry', 'venueprem', 'termbasis'],
