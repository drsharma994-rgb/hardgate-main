...
const EXPECTED_GROUPS = {
  ...
  gold:       ['super-gold', 'omnigold', 'omnigold1', 'optigold', 'newgold', 'golddirection', 'goldswing', 'goldscalp', 'goldultra', 'gold', 'goldpro', 'goldspot', 'goldcoint', 'goldpine', 'tauric', '80percent'],
