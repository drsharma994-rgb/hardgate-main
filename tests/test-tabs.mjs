...
const EXPECTED_GROUPS = {
  ...
  strategies: ['strats', 'meanrev', 'edge', 'best', 'pine', 'pine-msb', 'pine-sqz', 'pine-smf', 'pine-ht', 'carry', 'termbasis', 'scorecard'],
...
const ID2GROUP = { squeeze:'crypto', trendmx:'overview', oiflow:'crypto', liqs:'crypto', regime:'overview',
                   carry:'strategies', termbasis:'strategies', goldpro:'gold', strats:'strategies', meanrev:'strategies', edge:'strategies', pine:'strategies', 'pine-msb':'strategies', 'pine-sqz':'strategies', 'pine-smf':'strategies', 'pine-ht':'strategies',
