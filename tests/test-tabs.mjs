...
const EXPECTED_GROUPS = {
  ...
  strategies: ['strats', 'meanrev', 'super-setup', 'reversalsniper', 'edge', 'best', 'pine', 'pine-msb', 'pine-sqz', 'pine-smf', 'pine-ht', 'pine-smc', 'pine-cipher', 'pine-rf', 'pine-nw', 'pine-avwap', 'carry', 'venueprem', 'termbasis', 'scorecard', 'reliability', 'formationlab'],
...
const ID2GROUP = { squeeze:'crypto', trendmx:'overview', oiflow:'crypto', liqs:'crypto', chartvision:'crypto', regime:'overview',
                   carry:'strategies', venueprem:'strategies', termbasis:'strategies', goldpro:'gold', goldcoint:'gold', strats:'strategies', meanrev:'strategies', 'super-setup':'strategies', reversalsniper:'strategies', edge:'strategies', pine:'strategies', 'pine-msb':'strategies', 'pine-sqz':'strategies', 'pine-smf':'strategies', 'pine-ht':'strategies', 'pine-smc':'strategies', 'pine-cipher':'strategies', 'pine-rf':'strategies', 'pine-nw':'strategies', 'pine-avwap':'strategies',
...
assert(/<meta name="theme-color" content="#f4f6f9">/.test(html),
  'theme-color meta matches light data-dense chrome');
...
assert(!!manifest && manifest.display === 'standalone'
    && manifest.background_color === '#f4f6f9' && manifest.theme_color === '#f4f6f9',
  'manifest is installable: display standalone + light data-dense background/theme');
