...
const EXPECTED_GROUPS = {
  ...
  strategies: ['strats', 'meanrev', 'edge', 'best', 'pine', 'pine-msb', 'pine-sqz', 'pine-smf', 'pine-ht', 'pine-smc', 'pine-cipher', 'pine-rf', 'pine-nw', 'carry', 'termbasis', 'scorecard'],
...
const ID2GROUP = { squeeze:'crypto', trendmx:'overview', oiflow:'crypto', liqs:'crypto', regime:'overview',
                   carry:'strategies', termbasis:'strategies', goldpro:'gold', strats:'strategies', meanrev:'strategies', edge:'strategies', pine:'strategies', 'pine-msb':'strategies', 'pine-sqz':'strategies', 'pine-smf':'strategies', 'pine-ht':'strategies', 'pine-smc':'strategies', 'pine-cipher':'strategies', 'pine-rf':'strategies', 'pine-nw':'strategies',
...
assert(/<meta name="theme-color" content="#FFFFFF">/.test(html),
  'theme-color meta matches the light app chrome (--panel #FFFFFF)');
...
assert(!!manifest && manifest.display === 'standalone'
    && manifest.background_color === '#F8FAFC' && manifest.theme_color === '#FFFFFF',
  'manifest is installable: display standalone + light background/theme matching the app CSS');
