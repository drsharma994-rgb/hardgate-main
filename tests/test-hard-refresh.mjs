...
assert(groupTabs('gold') === 'gold,goldpro,goldcoint,goldspot,goldscalp,goldswing,goldpine,signallog',
  'GOLD group becomes gold,goldpro,goldcoint,goldspot,goldscalp,goldswing,goldpine,signallog');
