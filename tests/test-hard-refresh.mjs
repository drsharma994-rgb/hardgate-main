...
assert(groupTabs('overview') === 'execute,bias,regime,trendmx,rotation,news',
  'OVERVIEW group gains rotation after trendmx');
...
assert(groupTabs('gold') === 'gold,goldpro,goldspot',
  'GOLD group becomes gold,goldpro,goldspot');
