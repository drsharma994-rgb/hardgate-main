#!/usr/bin/env node
/* HARDGATE — Part7 S39–S48 OMNIGOLD + SCALP/SWING mint wire (hg-v574) */
import fs from 'fs';
...
console.log('\n== stamp ==');
{
  ...
  ok(/goldswing\.js\?v=574/.test(html), 'index goldswing ?v=');
  ok(/omnigold\.js\?v=574/.test(html), 'index omnigold ?v=');
}
