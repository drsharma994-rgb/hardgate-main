#!/usr/bin/env node
/* HARDGATE — Part5 S19–S28 OMNIGOLD + SCALP/SWING mint wire (hg-v576) */
import fs from 'fs';
...
console.log('\n== stamp ==');
{
  ...
  ok(/goldswing\.js\?v=576/.test(html), 'index goldswing ?v=');
  ok(/omnigold\.js\?v=576/.test(html), 'index omnigold ?v=');
}
